...
export default function MouseGradient() {
  ...
  useEffect(() => {
    ...
    // Kısa bir gecikme ile render et
      ...
      const animate = (t: number) => {
        ...
        try {
          ...
          blobs.forEach((blob, i) => {
            const x = width / 2 + Math.sin(t * blob.speed + blob.angle) * width * blob.offsetX;
            const y = height / 2 + Math.cos(t * blob.speed + blob.angle) * height * blob.offsetY;
